...
//   - deploymentcomponent:  deployment component catalog discovery (search, get by ID or kind)
//   - iacmodule:            IaC module catalog discovery (search official + org-scoped, get)
