...
type ConfigureWebhookInput struct {
	GithubCredentialID string `json:"github_credential_id" jsonschema:"required,ID of the GithubCredential to use for webhook configuration."`
...
func ConfigureWebhookTool() *mcp.Tool {
	return &mcp.Tool{
		...
		Description: "Configure a webhook on a GitHub repository using a GitHub credential. " +
...
func ConfigureWebhookHandler(serverAddress string) func(context.Context, *mcp.CallToolRequest, *ConfigureWebhookInput) (*mcp.CallToolResult, any, error) {
	return func(ctx context.Context, _ *mcp.CallToolRequest, input *ConfigureWebhookInput) (*mcp.CallToolResult, any, error) {
		if input.GithubCredentialID == "" {
			return nil, nil, fmt.Errorf("'github_credential_id' is required")
		}
		if input.RepoName == "" {
		...
		text, err := domains.WithConnection(ctx, serverAddress,
			func(ctx context.Context, conn *grpc.ClientConn) (string, error) {
				client := githubcredentialv1.NewGithubCommandControllerClient(conn)
				resp, err := client.ConfigureWebhook(ctx, &githubcredentialv1.GithubRepoWebhookRequest{
...
type RemoveWebhookInput struct {
	GithubCredentialID string `json:"github_credential_id" jsonschema:"required,ID of the GithubCredential used for the webhook."`
	RepoName           string `json:"repo_name" jsonschema:"required,Full repository name (e.g. 'owner/repo')."`
}
...
func RemoveWebhookTool() *mcp.Tool {
	return &mcp.Tool{
		...
		Description: "Remove a webhook from a GitHub repository. " +
			"Requires the GitHub credential ID and repository name.",
	}
}
...
func RemoveWebhookHandler(serverAddress string) func(context.Context, *mcp.CallToolRequest, *RemoveWebhookInput) (*mcp.CallToolResult, any, error) {
	return func(ctx context.Context, _ *mcp.CallToolRequest, input *RemoveWebhookInput) (*mcp.CallToolResult, any, error) {
		...
		text, err := domains.WithConnection(ctx, serverAddress,
			func(ctx context.Context, conn *grpc.ClientConn) (string, error) {
				client := githubcredentialv1.NewGithubCommandControllerClient(conn)
				_, err := client.RemoveWebhook(ctx, &githubcredentialv1.GithubRepoWebhookRequest{
					GithubCredentialId: input.GithubCredentialID,
					RepoName:           input.RepoName,
				})
				if err != nil {
...
func GetInstallationInfoHandler(serverAddress string) func(context.Context, *mcp.CallToolRequest, *GetInstallationInfoInput) (*mcp.CallToolResult, any, error) {
	return func(ctx context.Context, _ *mcp.CallToolRequest, input *GetInstallationInfoInput) (*mcp.CallToolResult, any, error) {
		...
		text, err := domains.WithConnection(ctx, serverAddress,
			func(ctx context.Context, conn *grpc.ClientConn) (string, error) {
				client := githubcredentialv1.NewGithubQueryControllerClient(conn)
				resp, err := client.GetInstallationInfo(ctx, &githubcredentialv1.GithubAppInstallationId{
...
type ListRepositoriesInput struct {
	GithubCredentialID string `json:"github_credential_id" jsonschema:"required,ID of the GithubCredential to list repositories for."`
...
func ListRepositoriesTool() *mcp.Tool {
	return &mcp.Tool{
		...
		Description: "List GitHub repositories accessible via a GitHub credential. " +
...
func ListRepositoriesHandler(serverAddress string) func(context.Context, *mcp.CallToolRequest, *ListRepositoriesInput) (*mcp.CallToolResult, any, error) {
	return func(ctx context.Context, _ *mcp.CallToolRequest, input *ListRepositoriesInput) (*mcp.CallToolResult, any, error) {
		...
		text, err := domains.WithConnection(ctx, serverAddress,
			func(ctx context.Context, conn *grpc.ClientConn) (string, error) {
				client := githubcredentialv1.NewGithubQueryControllerClient(conn)
				resp, err := client.FindGithubRepositories(ctx, &githubcredentialv1.FindGithubRepositoriesInput{
					GithubCredentialId: input.GithubCredentialID,
					SearchText:         input.SearchText,
				})
				if err != nil {
					return "", domains.RPCError(err, fmt.Sprintf("repositories for credential %q", input.GithubCredentialID))
				}
				return domains.MarshalJSON(resp)
			})
		if err != nil {
...
type GetInstallationTokenInput struct {
	GithubCredentialID string `json:"github_credential_id" jsonschema:"required,ID of the GithubCredential to generate an installation token for."`
}

func GetInstallationTokenTool() *mcp.Tool {
	return &mcp.Tool{
		Name: "get_github_installation_token",
		Description: "Generate a short-lived GitHub App installation token for a GitHub credential. " +
		...
		text, err := domains.WithConnection(ctx, serverAddress,
			func(ctx context.Context, conn *grpc.ClientConn) (string, error) {
				...
				resp, err := client.GetInstallationToken(ctx, &apiresource.ApiResourceId{
					Value: input.GithubCredentialID,
				})
				if err != nil {
					return "", domains.RPCError(err, fmt.Sprintf("installation token for credential %q", input.GithubCredentialID))
				}
				return domains.MarshalJSON(resp)
			})
		if err != nil {
