...
// beyond standard connection CRUD. These tools use the GithubCommandController
// and GithubQueryController RPCs from the githubconnection/v1 proto package.
//
...
//   - list_github_repositories:      search repositories accessible via a GitHub connection
