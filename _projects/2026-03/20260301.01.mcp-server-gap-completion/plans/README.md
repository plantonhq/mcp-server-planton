...
| `t14-pipeline-log-retrieval.plan.md` | Completed | 2026-03-01 | 2026-03-01 | Add 2 pipeline log retrieval tools (get_pipeline_logs, get_infra_pipeline_logs) + generic DrainStream[T] utility. Stream-collect-return pattern: internally calls streaming getLogStream, returns batch. |
